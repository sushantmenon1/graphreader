...
def get_primary_assistant_prompt():
    primary_assistant_prompt = ChatPromptTemplate.from_messages(
        [
            ...
            read_chunk: Concatenates and returns the document text for the given chunk IDs. Always use this function to answer the queries.
            ...
            Never use the facts present in the results of the get_node_data function to directly answer the question. Make sure to always use the read_chunk function to read from the filtered chunk_ids.
